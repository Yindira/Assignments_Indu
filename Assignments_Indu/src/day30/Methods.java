...
public class Methods {
	...
	public static void pickLeastPrice(String locator, String value, String site) {
		...
		if (locator.equals("cssSelector")) {
			...
			leastPrice = driver.findElement(By.xpath(value)).getText().substring(2);
		}
		System.out.println("Below offered by "+ site);
